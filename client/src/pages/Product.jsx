...
const Product = () => {
  ...
  const fetchProduct = async () => {
    try {
      const req = await fetch(`https://eggys-place-grn2.onrender.com/api/product/${productId}`);
      const res = await req.json();
      // console.log(res.product);
      setProduct(res.product)

      const allProducts = await fetch(`https://eggys-place-grn2.onrender.com/api/product/all-products`);
